...
export function Hero() {
  return (
    <Container className="py-8 text-center min-h-screen flex flex-col justify-center h-full items-center">
      <img src="/fillers/Icon.png" alt='IdeaHatch.in' />
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-fuchsia-600">
          ...
          <span className="relative">IdeaHatch</span>
        </span>{' '}
        <br />
        <small><small>Where ideas take flight.</small></small>
      </h1>
      <p className="mx-auto my-6 max-w-2xl text-3xl tracking-tight text-slate-700">
        Join a growing community of innovators and bring your vision to life!
      </p>
      <p className="mx-auto my-6 max-w-2xl tracking-tight text-slate-700">
